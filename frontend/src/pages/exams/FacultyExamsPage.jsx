...
export default function FacultyExamsPage() {
  ...
  // Form state for faculty to schedule test / MST
  ...
  // Form state for adding coding content to test
          ...
          if (Array.isArray(assignments)) {
            for (const item of assignments) {
              ...
              fetchedExams.push({
                ...
                isMst: Boolean(isMst),
                title: item.title,
                description: item.description || "Course assessment paper.",
  ...
  async function handleScheduleSubmit(e) {
    ...
    if (!scheduleForm.courseId) {
      setScheduleStatus({ loading: false, success: "", error: "Please select a course for the exam/assignment." });
      return;
    }
    ...
    try {
      ...
      setScheduleStatus({ loading: false, success: "Paper created successfully!", error: "" });
      ...
      <div className="lc-dashboard-container" style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem 1.5rem" }}>
        ...
        {loading && (
          <div style={{ padding: "3rem", textAlign: "center", color: "var(--lc-text-muted)" }}>
            <p>Loading course test papers...</p>
          </div>
        )}
        ...
        {!loading && filteredExams.length === 0 ? (
          <div style={{
            ...
            <h3>No course examination papers created yet</h3>
            <p style={{ fontSize: "0.85rem", marginTop: "0.25rem" }}>
              Click "+ Create Test / MST Paper" above to schedule a new test.
            </p>
          </div>
        ) : (
            ...
            {filteredExams.map((exam) => (
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", marginTop: "0.5rem" }}>
                  ...
                  <Link
                    to={`/faculty/courses/${exam.courseId}`}
                    style={{
                      background: "#ff7e29",
                      color: "#fff",
                      borderRadius: "8px",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ fontSize: "0.85rem", color: "var(--lc-text-muted)", marginBottom: "1.5rem" }}>
                Schedule start & end times, set test duration, and configure proctoring.
              </p>
              ...
              <form onSubmit={handleScheduleSubmit}>
                ...
                <div className="lc-form-group" style={{ marginBottom: "1rem" }}>
                  <label className="lc-input-label">Description / Instructions</label>
                  <textarea
                    placeholder="e.g. Test covers Units 1 & 2."
                    className="lc-form-input"
                    rows="2"
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", gap: "0.75rem" }}>
                  ...
                  >
                    {scheduleStatus.loading ? "Scheduling..." : "Create Paper"}
                  </button>
                </div>
              </form>
            </div>
